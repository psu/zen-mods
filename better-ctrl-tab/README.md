...
- Remove preference _Panel - Zoom_
- Added preference _Panel - Border Color_
- Added preference _Panel - Border Width_
- Added preference _Panel - Max-width_
- Added preference _Panel - Adjust Vertical Position_
